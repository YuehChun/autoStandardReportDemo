...
select a.sinLog as a,a.time_a as b,a.cnt as c,a.sintype as sintype from 
...
select b.time_a as a,a.max_cnt as b,a.sintype as sintype from (
...
select a.sinLog as a,cast(a.percent*100 as int) as b,b.sinLog as c,cast(b.percent*100 as int)  as d,(cast(a.percent*100 as int)-cast(b.percent*100 as int)) as e,a.sintype as sintype from  
...
select a.sinLog as a,a.cnt as b,a.avg_time as c,b.totalnum as d,b.total_avg_time as e,a.sintype as sintype from (
...
-- 當地A的人次為多，且以B時當下現場人數達到最高約有C的人，相較於活動最低點D時的人數E，約有F倍
			select a.county as a,a.time_a as b,a.cnt as c,b.time_a as d,b.cnt as e,(cast((a.cnt/b.cnt)*10 as int)/10) as f,a.sintype as sintype from (
...
-- 其次為A的居民，且以B時當下現場人數達到最高約有C的人，相較於活動最低點D時的人數E，約增加F人
	...
	select a.town as a,a.time_a as b,a.cnt as c,b.time_a as d,b.cnt as e,(a.cnt-b.cnt) as f,a.sintype as sintype from (
...
-- fig 6
select  'fig6' as sin,a.otype as otype,(a.cnt/b.sum_num) as percent,a.sintype as sintype from ans1.yct_auto_cc_aggre_county_num a
...
-- fig 6 and table 1 
select  a.otype as otype,(a.cnt/b.sum_num) as percent,a.cnt as cnt,a.sintype as sintype from ans1.yct_auto_cc_aggre_county_num a
join (select sintype,sum(cnt) as sum_num from  ans1.yct_auto_cc_aggre_county_num where  sintype=${hiveconf:act_name} group by sintype)b on a.sintype=b.sintype
where  a.sintype=${hiveconf:act_name};
...
-- fig 7
select  'fig7' as sin,a.otype as otype,(sum(a.cnt)/b.sum_num) as percent,a.sintype as sintype from ans1.yct_auto_cc_aggre_town_num a
...
-- fig 7 and table 1 
select  a.otype as otype,(sum(a.cnt)/b.sum_num) as percent,sum(a.cnt) as cnt ,a.sintype as sintype from ans1.yct_auto_cc_aggre_town_num a
join (select sintype,sum(cnt) as sum_num from  ans1.yct_auto_cc_aggre_town_num where  sintype=${hiveconf:act_name} group by sintype)b on a.sintype=b.sintype
where  a.sintype=${hiveconf:act_name}
group by a.otype,a.sintype,b.sum_num;
...
select b.otype as a,b.cnt as b,(b.cnt/a.sum_num) as c,a.sintype as sintype from 
...
select b.otype as a,b.cnt as b,a.county as c,(b.cnt/a.sum_num) as d,a.sintype as sintype from 
...
-- fig 8
select 'fig8' as sin,a.time_a as time_a,a.age_type as age_type,a.cnt as cnt,a.sintype as sintype from ans1.yct_auto_cc_age_log_point a where a.sintype=${hiveconf:act_name};

-- fig 8 commnet
-- 活動期間增減差異最多的群族為A，現場人數最多的時間點在C，而最少的時間點在D
select a.age_type as a,b.time_a as b,c.time_a as c,a.sintype as sintype from 
(
...
(
	select a.sintype,a.age_type,row_number() over(partition by a.sintype as sintype order by (a.ma-a.mi) ASC) as sorted_num from 
	(select a.sintype,a.age_type,max(cnt) as ma,min(cnt) as mi from ans1.yct_auto_cc_age_log_point a where a.sintype=${hiveconf:act_name} group by a.sintype,a.age_type)a
)a join (
	select a.time_a,a.age_type,a.sintype,a.cnt,row_number() over(partition by a.sintype,a.age_type order by cnt desc) as sorted_num  from ans1.yct_auto_cc_age_log_point a 
	where a.sintype=${hiveconf:act_name}
...
-- fig 9
select 'fig9' as sin,a.age_type as age_type,a.percent as percent,a.avg_stay as avg_stay,a.sintype as sintype from ans1.yct_auto_cc_age_stay_percent a where a.sintype=${hiveconf:act_name};

		
-- fig 9 commnet
--  占比最高的年齡族群為A，最低的年齡族群為B，相差C%
select a.age_type as a,b.age_type as b,(a.percent-b.percent) as c,a.sintype,a.sintype as sintype from (
...
select a.age_type as a,b.age_type as b,(a.avg_stay-b.avg_stay) as c,a.sintype,a.sintype as sintype from (
...
-- fig 10
select 'fig10' as sin,a.county as county,a.avg_age as avg_age,a.cnt as cnt,a.sintype as sintype from ans1.yct_auto_cc_age_avg_county a where a.sintype=${hiveconf:act_name} order by cnt desc;
...
-- fig 11
select 'fig11' as sin,a.town as town,a.avg_age as avg_age,a.cnt as cnt,a.sintype as sintype from ans1.yct_auto_cc_age_avg_town a where a.sintype=${hiveconf:act_name} order by cnt desc;
			
-- fig 11 commnet
-- 細看鄉鎮區，人潮最多的鄉鎮區為A，其平均年齡為B，次者C地區的平均年齡為D
select a.town as a,a.avg_age as b,b.town as c,b.avg_age as d,a.sintype as sintype from (
